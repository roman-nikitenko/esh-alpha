      ...
      <div className="contact__block">
        ...
        <div className="contact__block__form">
          <h2 className="contact__block__title">
            Love to hear <span className="form__title--stong">from you,leave a</span>  message
          </h2>
          ...
          <form className="form">
            ...
            <label className="form__lable" htmlFor="message">
              Message
            </label>
              <textarea
            ...
            <button type="submit" className="button button--dark_purple">
              Send now
            </button>
          </form>
        </div>
